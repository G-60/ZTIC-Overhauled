...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      ...
      {
        image: img11,
        text: 'Gallery image 11'
      },
      {
        image: img12,
        text: 'Gallery image 12'
      },
      {
        image: img13,
        text: 'Gallery image 13'
      },
      {
        image: img14,
        text: 'Gallery image 14'
      },
      {
        image: img15,
        text: 'Gallery image 15'
      },
      {
        image: img16,
        text: 'Gallery image 16'
      },
      {
        image: img17,
        text: 'Gallery image 17'
      },
      {
        image: img18,
        text: 'Gallery image 18'
      },
      {
        image: img19,
        text: 'Gallery image 19'
      },
      {
        image: img20,
        text: 'Gallery image 20'
      }
    ];
